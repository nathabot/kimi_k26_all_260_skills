...
|------|-----------|-------|--------|-----------------|
| **Task 1** | `SKILL-equity-task1.md` | User request + stock code | Research Document (≥9,000 words) | 13 completeness + 4 data quality checks |
...
---
*Skill file: `/app/.agents/skills/equity-researcher/SKILL.md`*
