...
## Workflow: Analyze and Generate

```
1. Pull recent ad performance data (from your ad platform's export or dashboard)
...
*Source: `/app/.agents/skills/ad-creative/SKILL.md`*
