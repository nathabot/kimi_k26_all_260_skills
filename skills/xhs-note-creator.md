...
description: "小红书笔记全流程创作工具，根据用户提供的素材或主题自动撰写符合平台风格的笔记内容（标题+正文+标签），并渲染生成精美的3:4比例图片卡片（含封面和正文卡，支持8种视觉主题与4种分页模式），最终可一键发布。当用户提出创作小红书笔记、生成种草文案、需要将内容转为图片卡片，或提及“小红书”、“笔记”、“封面”、“视觉主题”、“一键发布”等关键词时触发。"
---

<!-- Localized from: auto-redbook-skills -->
