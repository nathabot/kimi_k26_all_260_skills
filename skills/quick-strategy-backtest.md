...
- [ ] Both the reply and the dashboard must use event-level metrics: average / median / win rate / max / min single-event result; **do not** report Sharpe / annualized return / max drawdown
...
---
*Skill source: `/app/.agents/skills/quick-strategy-backtest/SKILL.md`*
